def main(counters_list, counters,  prep,  rack, path, sources, fill, aliquots, chaser, verbose, prep_container):
        ld = LS_open(counters_list, rack, path, sources, verbose, "calibration_sampling")
        LS_to(prep, ld)
        ...
        c = ld.make_container("ICP1", "calibration")
        prep_container = ld.update_container(c, prep_container)
